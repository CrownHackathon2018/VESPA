...
class MastersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create master" do
    assert_difference('Master.count') do
      post masters_url, params: { master: { comment: @master.comment, promEnvironment: @master.promEnvironment, reqdt: @master.reqdt, userID: @master.userID, vikEnvironment: @master.vikEnvironment, viknum: @master.viknum } }
    end
  ...
  test "should update master" do
    patch master_url(@master), params: { master: { comment: @master.comment, promEnvironment: @master.promEnvironment, reqdt: @master.reqdt, userID: @master.userID, vikEnvironment: @master.vikEnvironment, viknum: @master.viknum } }
